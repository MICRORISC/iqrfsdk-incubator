...
import com.microrisc.jlibdpa.types.SimpleDPARequest;
...
public class MainTest {
   ...
   public static void main(String[] args) throws Exception {
      ...
      DPAConfiguration config = new DPAConfiguration(iqrfConfig,
              NoTimingManager.class);
      JLibDPA dpa = new SimpleJLibDPA(config);

      DPARequest request = new SimpleDPARequest(new short[]{0x00, 0x00, 0x07,
         0x01, 0xFF, 0xFF});
