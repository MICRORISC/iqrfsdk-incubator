...
public final class CDCNetworkLayer
    ...
    private String clientId = "b827eb26c73d-cdc";
            ...
            throws J_CDCImplException, Exception 
    {
        ...
        this.mqttCommunicator = new MQTTCommunicator(url, clientId, cleanSession, quietMode, userName, password, "LP");
    }
    ...
    private void sendIncomingMessage(short[] userData) {
        ...
        // web log
        try {
            mqttCommunicator.publish(MQTTTopics.LP_DPA_PACKETS, 2, buffer.toString().getBytes());
